...
import SingleFeaturesTab from "./SingleFeaturesTab";
...
const FeaturesTab = () => {
  ...
  return (
    <>
      {/* <!-- ===== Features Tab Start ===== --> */}
      <section className="relative pb-20 pt-18.5 lg:pb-22.5" id="persons">
          ...
          >
            {featuresTabData.map((feature, key) => (
              <div
                ...
                key={key}
              >
                <SingleFeaturesTab featureTab={feature} />
              </div>
            ))}
          </motion.div>
          {/* <!-- Tab Content End --> */}
