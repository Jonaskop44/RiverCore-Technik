      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONEN`,
              subtitle: `Wir pflegen Ihre Daten aus der Ferne von überall auf der Welt.`,
              description: `Mit fortgeschrittener Software und Technologie ist es uns möglich, schnell und sicher auf Ihre Daten zugreifen zu können`,
            }}
          />
        ...
        <div className="pattern-dots pattern-blue-500 pattern-bg-white pattern-size-4 pattern-opacity-10 relative z-10 mx-auto mt-15 max-w-c-1154 px-4 md:px-8 xl:mt-20 xl:px-0">
          ...
          <div className="flex flex-wrap justify-around gap-y-10">
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/teamviewer.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="animate_top w-1/6"
            >
              <div className="h-[11px] w-[11px] rounded-full bg-[#F32536]"></div>
            </motion.div>
